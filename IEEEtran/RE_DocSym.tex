...
% in the abstract
\begin{abstract}
\tatiana{Here we present \care in Requirements Engineering (CARE) for handling unstructured 
textual requirements. }
%\ca method brings unformalized, vague textual requirements into 
...
%
%\tatiana{Requirements consists of incoming information to all levels of an implemented system. 
...
%
%\tatiana{Moreover, as long as requirements meta-data spread throughout all system development phases 
...
%
%\tatiana{Summing up all points from above, we postulate, that \care impacts efficiently on requirements 
